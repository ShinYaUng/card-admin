...
namespace NueGames.NueDeck.Scripts.Data.Characters
{
    ...
    public class EnemyCharacterData : CharacterDataBase
    {
        ...
        [Header("Rewards")]
        [SerializeField] private int expReward = 20;   // 🟢 ค่าประสบการณ์ที่ศัตรูตัวนี้ให้
        [SerializeField] private int goldReward = 10;   // 🟢 เพิ่ม
        public List<EnemyAbilityData> EnemyAbilityList => enemyAbilityList;
        public EnemyBase EnemyPrefab => enemyPrefab;
        public int ExpReward => expReward;             // 🟢 property สำหรับอ่านค่า
        public int GoldReward => goldReward;            // 🟢 เพิ่ม
