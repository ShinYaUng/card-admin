...
namespace NueGames.NueDeck.Scripts.Data.Settings
{
    ...
    public class GameplayData : ScriptableObject
    {
        ...
        [SerializeField] private int[] cardUpgradeCosts = new int[] { 50, 120, 250 };
        public int[] CardUpgradeCosts => cardUpgradeCosts;
        ...
        public int GetUpgradeCostForStep(int nextStep/*1..3*/)
        {
            if (nextStep <= 0 || nextStep > cardUpgradeCosts.Length) return 0;
            return cardUpgradeCosts[nextStep - 1];
        }
    }
}