...
namespace NueGames.NueDeck.Scripts.Managers
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public void SetGameplayData(GameplayData newData)
        {
            gameplayData = newData;
            InitGameplayData(); // √’‡´Áµ PersistentGameplayData „À¡Ë
            SetInitalHand();
        }
        public void SetCurrentUser(string uid, string displayName, string shownName)
        {
            CurrentUserId = uid;
            CurrentUserDisplayName = string.IsNullOrEmpty(shownName) ? displayName : shownName;
        }
