...
namespace NueGames.NueDeck.Scripts.UI
{
    public class CombatCanvas : CanvasBase
    {
        ...
        [SerializeField] private TextMeshProUGUI eventTextField;
        public TextMeshProUGUI EventTextField => eventTextField;
        ...
        private void Awake()
        {
            ...
            if (eventTextField) eventTextField.text = "Event: -";
        }
        #endregion
        ...
        {
            if (eventTextField) eventTextField.text = text;
        }
        #endregion
    }
}